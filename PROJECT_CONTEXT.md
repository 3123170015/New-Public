...
## Current snapshot — v4.16.26 (Jan 2026)
...
- **Theme Builder**: upload theme preset (theme.json + assets) + set active preset in Admin Config, inject CSS variables at runtime.
- **Theme Builder**: upload theme preset (theme.json + assets), set active preset in Admin Config, inject CSS variables at runtime.
- **Growth/ARPU**:
